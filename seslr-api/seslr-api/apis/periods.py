...
class Periods(Resource):
    ...
    def get(self):
        ...
        query = "SELECT column_name FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'find_spot_chronology' AND column_name != 'find_spot_id' AND column_name != 'based_on';"
...
class Period(Resource):
    ...
    def get(self, period):
        ...
        query = 'SELECT find_spot_id FROM public.find_spot_chronology WHERE {} = true;'.format(psycopg2.extensions.quote_ident(period, db))
