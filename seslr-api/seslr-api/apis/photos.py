...
api = Namespace('Photos', description='Information on the photos taken at find spots.')

photos = api.model('Photos', {
    'photo_ids': fields.List(fields.Integer(), description="All photo ids found in the database.")
})
...
class Photos(Resource):
    ...
    def get(self, photo_id):
        ...
        if photo_info is None:
            raise NotFound('No info found for photo with id: {}'.format(photo_id))
